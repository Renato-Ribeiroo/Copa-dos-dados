...
image = Image.open("copa-do-mundo-2022-catar_logo.png")
st.image(image)

st.title("Copa dos Dados")
st.text("Algoritimo de Machine Learning capaz de prever qual time irá ganhar a Copa do Mundo de 2022")

df_selecoes = pd.read_csv("C:/Users/Renato/Projetos Python/Previsao-Copa-2022/Deploy/selecoes2022.csv")
...
df_campeoes = pd.read_csv('C:/Users/Renato/Projetos Python/Previsao-Copa-2022/Deploy/Campeoes.csv')
...
if st.button('Ralizar predição do Jogo'):
    st.text(text1)